    ...
    <div class="row">
        ...
        <div class="col-md-8 p-5">
            <div class="dashboard-content pt-2">
                ...
                ?>
                <form action="customer_add_post_code.php" method="post">
                    <div class="form-group">
                        <label>Hospital Name</label>
                        <input type="hidden" class="form-control" name="customer_id" value="<?php echo $active_id ?>">
                    ...
                    <button type="submit" class="btn button primary_color px-5">Post</button>
                </form>
            </div>
        </div>
    </div>
