                            ...
                            <div class="single-post h-100">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text mb-2"><span>Hospital: </span><?= $single_data['hospital_name'] ?></p>
                                        ...
                                        <!-- Update & Delete  -->
                                        <a class="btn primary_color text-white" href="customer_update_post.php?id=<?= $single_data['post_id'] ?>">
                                            Update
                                        </a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a class="btn btn-danger" href="customer_delete_post.php?id=<?= $single_data['post_id'] ?>">
                                                            Delete
                                                        </a>
                                                    </div>
                                                </div>
