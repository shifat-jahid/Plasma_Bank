...
$query = "SELECT r.id,r.username,r.email,r.user_type,p.post_id,p.hospital_name,p.date,p.phone,p.blood_group,p.address,p.post
        ...
        JOIN register as r
        ON p.user_id = r.id
        WHERE r.user_type = 'Customer' AND p.blood_group = '$search_key'
        ";
    ...
    <div class="row">
        ...
        <div class="col-md-8 p-4">
            <div class="section-header mb-2">
                <h1>All Post By Customer</h1>
            </div>
            <!-- Search Start  -->
            <form method="post" action="admin_customer_post_search.php">
